import {
  MeshBasicMaterial, Mesh, Texture, Vector3, Raycaster, Vector2, Sphere, SRGBColorSpace,
} from 'three';
...
import { activeProvider, REQUEST_SIZE } from './globe/provider';
import {
  US_FRAME_BOUNDS, EARTH_RADIUS_SCENE, SCENE_UNITS_PER_MERCATOR_UNIT,
  worldX, worldY, xToLng, yToLat, wrapLon, wrapCellIx, sphereXYZ, sphereNorth, sphereEast,
} from './globe/mercatorMath';
import { applyGlobeShading } from './globe/shading';
import { buildGroundPatch } from './globe/groundPatch';
import { ensureGlobeBase, setGlobeBaseVisible } from './globe/globeBase';
...
// flat Y height.
//
// This file is the interactive overview controller — camera/flight/input/
// UI. The persistent, mount-independent globe rendering data (base globe,
// whole-globe/US-region/polar-ring imagery, borders) lives in globe/
// instead (see globeBase.js), fetched once for the app's whole lifetime and
// just shown/hidden here on every mount/dispose.
